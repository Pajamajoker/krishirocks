...
import GovtSignin from './GovtSignin.js'
import GovtSignUp from './GovtSignUp.js'
        ...
        return (
            <div>
                <Switch>
                    ...
                    <Route  path="/govtsignin" component={GovtSignin}></Route>
                    <Route  path="/signupgovt" component={GovtSignUp}></Route>
